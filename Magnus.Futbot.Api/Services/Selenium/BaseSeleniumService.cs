...
namespace Magnus.Futbot.Api.Services.Selenium
{
    public class BaseSeleniumService
    {
        ...
        public static DriverInstance GetInstance(string username)
        {
            ...
            chromeOptions.AddArgument(@$"user-data-dir={Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData)}\Google\Chrome\User Data\{username.Split("@").FirstOrDefault()}2\Default");
